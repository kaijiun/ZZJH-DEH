...
import com.mmlab.game.module.GroupSearch;
import com.mmlab.game.module.Id;
import com.mmlab.game.module.LoginForm;
import com.mmlab.game.module.Room;
...
public class GameActivity extends AppCompatActivity {
    ...
    private LoginFragemet loginFragemet;
    ...
    public static void setGroup_leader_id(int group_leader_id) {
        GameActivity.group_leader_id = group_leader_id;
    }
    ...
    public static void setUser_room_list(List<Room> user_room_list) {
        GameActivity.user_room_list = user_room_list;
    }
    ...
    public static void setUser_group_list(List<Group> user_group_list) {
        GameActivity.user_group_list = user_group_list;
    }
    ...
    public static void setGame_data(GameData game_data) {
        GameActivity.game_data = game_data;
    }
    ...
    public static void setPick_chest_id(int pick_chest_id) {
        GameActivity.pick_chest_id = pick_chest_id;
    }
    ...
    public static void setPick_chest_text(String pick_chest_text) {
        GameActivity.pick_chest_text = pick_chest_text;
    }
    ...
    public static void setSrc_id(int src_id) {
        GameActivity.src_id = src_id;
    }

    public static Context getAppContext() {
        return GameActivity.getAppContext();
    }

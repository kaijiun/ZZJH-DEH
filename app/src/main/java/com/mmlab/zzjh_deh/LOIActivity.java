...
import com.mmlab.zzjh_deh.adapter.LOISequenceAdapter;
import com.mmlab.zzjh_deh.model.LOIModel;
import com.mmlab.zzjh_deh.model.LOISequenceModel;
import com.mmlab.zzjh_deh.save_data.SaveLOISequence;
import com.mmlab.zzjh_deh.service.HttpAsyncTask;
import com.mmlab.zzjh_deh.service.TaskCompleted;
...
public class LOIActivity extends AppCompatActivity implements TaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* accountForLogin = bundle.getString("account");
        ula = bundle.getString("ula");
        ulo = bundle.getString("ulo");
...
//		}
        ...
        if(type.equals("LOI-Id")) {
            ...
            mRecyclerView.setAdapter(new LOISequenceAdapter(this, loiSequenceList, "LOI-Sequence", model.getIdentifier()/*,accountForLogin , ula , ulo , uuid*/));
        }else {
            ...
            mAdapter = new LOISequenceAdapter(this, loiSequenceList, "LOI-Sequence", model.getIdentifier()/*, model.getContributor(),accountForLogin , ula , ulo,uuid*/);
            mRecyclerView.setHasFixedSize(true);
            mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onTaskComplete(String response, String type) {
        if (type.equals("IP")) {
            ...
            if (type.equals("LOI-Sequence")) {
                ...
                mAdapter = new LOISequenceAdapter(this, loiSequenceList, type, model.getIdentifier(),model.getContributor(),MiniActivity.getServer()/*,accountForLogin , ula , ulo,uuid*/);
                mRecyclerView.setHasFixedSize(true);
                mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
                mRecyclerView.setAdapter(mAdapter);

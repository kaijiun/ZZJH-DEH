...
import com.mmlab.zzjh_deh.AOIActivity;
import com.mmlab.zzjh_deh.LOIActivity;
...
public class LOISequenceAdapter extends RecyclerView.Adapter<LOISequenceAdapter.LOISequenceViewHolder> {
    ...
    String id = "";
    String mAccountForLogin = "";
    String mUla = "";
    String mUlo = "";
    String mUuid = "";

    public LOISequenceAdapter(Context context, ArrayList<LOISequenceModel> models, String type, String identifier,String o/*,String account,String ula , String ulo,String uuid*/) {
       ...
       /* mUla = ula;
        mUlo = ulo;
        mAccountForLogin = account;
        mUuid = uuid;*/
    }public LOISequenceAdapter(Context context, ArrayList<LOISequenceModel> models, String type, String identifier/*,String account,String ula , String ulo,String uuid*/) {
        mInflater = LayoutInflater.from(context);
        mModels = models;
        mContext = context;
        mType = type;
        ...
        mAccountForLogin = account;
        mUuid = uuid;*/
    }public LOISequenceAdapter(Context context, ArrayList<LOISequenceModel> models, String type, String identifier,String o,ProxyService server/*,String account,String ula , String ulo , String uuid*/) {
        mInflater = LayoutInflater.from(context);
        mModels = models;
        mContext = context;
        mType = type;

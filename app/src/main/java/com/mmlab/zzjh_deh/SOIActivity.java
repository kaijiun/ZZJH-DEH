...
import com.mmlab.zzjh_deh.save_data.SaveSOISequence;
...
public class SOIActivity extends AppCompatActivity implements TaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("重大  Bug ::" + MiniActivity.account_for_login);
        System.out.println("重大  Bug ::" + MiniActivity.curr_lat);
        System.out.println("重大  Bug ::" + MiniActivity.curr_lng);
        System.out.println("重大  Bug ::" + MiniActivity.uuid);
...
//		}
        ...
        mAdapter = new LOISequenceAdapter(this, soiSequenceList,"SOI-Sequence", model.getIdentifier(),model.getContributor()/*, accountForLogin , ula , ulo , uuid*/);
    ...
    public void onTaskComplete(String response, String type) {
        ...
        if (type.equals("IP")) {
            ...
            if (type.equals("SOI-Sequence")) {
                ...
                mAdapter = new LOISequenceAdapter(this, soiSequenceList, type, model.getIdentifier(),model.getContributor()/*, accountForLogin , ula , ulo , uuid*/);
                mRecyclerView.setHasFixedSize(true);
                mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
                mRecyclerView.setAdapter(mAdapter);

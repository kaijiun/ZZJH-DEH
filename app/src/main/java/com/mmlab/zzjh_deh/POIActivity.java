...
import com.mmlab.zzjh_deh.widget.AudioPlayer;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
       ...
       // uuid = getIntent().getStringExtra("uuid");
        ...
        Log.d("account" , MiniActivity.account_for_login);
       //Log.d("where from ", where_from);


        uploadLog(where_from,MiniActivity.account_for_login,String.valueOf(MiniActivity.curr_lat),String.valueOf(MiniActivity.curr_lng),action,clicked_poi_id,MiniActivity.uuid);

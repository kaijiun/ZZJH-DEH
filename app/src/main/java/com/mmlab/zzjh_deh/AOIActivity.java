...
import com.mmlab.zzjh_deh.save_data.SaveAOISequence;
...
//		}
        ...
        if(type.equals("AOI-Id")) {
            ...
            mRecyclerView.setAdapter(new LOISequenceAdapter(this, aoiSequenceList, type2, model.getIdentifier()/* , accountForLogin , ula , ulo , uuid*/));
        }else{
            type2 = "AOI-Sequence";
            ...
            mAdapter = new LOISequenceAdapter(this, aoiSequenceList, type2, model.getIdentifier(), model.getContributor()/*, accountForLogin , ula , ulo , uuid*/);
            mRecyclerView.setHasFixedSize(true);
            mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onTaskComplete(String response, String type) {
        ...
        if (type.equals("IP")) {
            ...
            if (type.equals("AOI-Sequence")) {
                ...
                mAdapter = new LOISequenceAdapter(this, aoiSequenceList, type, model.getIdentifier(), model.getContributor(),MiniActivity.getServer()/*, accountForLogin , ula , ulo , uuid*/);
                mRecyclerView.setHasFixedSize(true);
                mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
                mRecyclerView.setAdapter(mAdapter);
